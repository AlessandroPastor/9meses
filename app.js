...
let showImages = false; // Para mostrar solo una vez las imágenes/mensaje
function anim() {
	...
	if (done && !showImages) {
		...
		document.getElementById('mensajeFinal').classList.add('show');
	
		// Efecto máquina de escribir 💬
		const mensaje = 'Hoy celebramos 9 meses de amor, sonrisas, aprendizajes y momentos inolvidables. Gracias por ser mi paz, mi alegría y mi todo. Te amo con cada parte de mi alma, y seguiré amándote cada día más. 💖 Para siempre: Brunella & Alessandro 💫';
